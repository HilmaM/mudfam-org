...
exports.signup_get = function (req, res, next) {
  res.render('logging/signup', {title: 'Signup '});
};
...
exports.signup_post = [ (req, res, next) => {
  ...
  try {
    ...
    console.log('error', 'check the fle')
  ...
  let checkUser = UserModel.findUser(userData.u_sername);
  ...
  if(!checkUser.length) {
    UserModel.create(user)
      .then(function(result){
        ...
        res.redirect('/insurer/logging/login');
      })
      .catch(function(e){
