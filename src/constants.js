...
export const category = [
  ...
  { code: 'PE', label: 'Personal' },
  { code: 'WO', label: 'World' },
  { code: 'RO', label: 'Romance' },
  { code: 'MU', label: 'Music' },
  { code: 'CU', label: 'Culture' },
  { code: 'TR', label: 'Travel' },
  { code: 'TE', label: 'Technology' },
  { code: 'OP', label: 'Opinion' },
  { code: 'FO', label: 'Folklore' }
];

export const titles = [
  { code: 'Dr', label: 'Doctor' },
  { code: 'Prof', label: 'Professor' },
  { code: 'Mr', label: 'Master' },
...
export const role = [
  { code: 'Ad', label: 'Admin' },
  { code: 'Man', label: 'Manager' },
  { code: 'Edi', label: 'Editor' },
  { code: 'Us', label: 'User' }
];
